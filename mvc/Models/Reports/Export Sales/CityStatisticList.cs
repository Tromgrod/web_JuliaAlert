...
{
    public class TotalSumCityStatistic
    {
    ...
    [Bo(DisplayName = "Отчет по городам",
        CustomPage = true,
        AdditionalJoin = TotalSumCityStatistic.AdditionalApply,
    ...
    public class CityStatisticList : ReportBase
    {
