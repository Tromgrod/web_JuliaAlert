...
{
    [Bo(DisplayName = "Список приходов фурнитуры",
    CustomPage = true)]
    public class SupplyFindingList : ReportBase
    {
        public override string GetLink() => "DocControl/SupplyFinding/" + SupplyFinding.Id;
        ...
        [Common(DisplayName = "Склад", _Sortable = true, _Searchable = true),
         Template(Mode = Template.SearchSelectList),
         Access(DisplayMode = DisplayMode.Simple | DisplayMode.Search | DisplayMode.Excell)]
