...
{
    [Bo(DisplayName = "Анализ по моделям MD",
        CustomPage = true,
        RecordsPerPage = int.MaxValue,
        SpPopulateReport = nameof(SpecificProduct_ModelList),
    ...
    public class SpecificProduct_ModelList_LocalSales : ReportBase
    {
        public override string GetLink() => "Report/OrderList_LocalSales/Product/JuliaAlert.Models.Objects/" + this.UniqueProduct.Product.Id;
        ...
        public override string QueryFilter(LIB.BusinessObjects.User User) => $"AND t.CurrencyId = " + (long)Currency.Enum.MDL;
